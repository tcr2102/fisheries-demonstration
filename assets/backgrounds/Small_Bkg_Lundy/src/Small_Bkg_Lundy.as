package {
	...
	public class Small_Bkg_Lundy extends Sprite
	{
		...
		private var bmp:BitmapData = new flash.display.BitmapData(425,390,true,0x00000000);
		private var waterbmd:BitmapData = new flash.display.BitmapData(425,80,false,0x00000000);
		...
		public function onEnterFrame(e:Event):void{
			...
			this.perlinOffset[1].x+=2;
			this.perlinOffset[1].y+=2;
		...
		public function Small_Bkg_Lundy()
		{
