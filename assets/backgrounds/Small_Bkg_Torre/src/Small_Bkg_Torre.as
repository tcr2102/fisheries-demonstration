package {
	...
	public class Small_Bkg_Torre extends Sprite
	{
		...
		private var bmp:BitmapData = new flash.display.BitmapData(325,190,true,0x00000000);
		private var waterbmd:BitmapData = new flash.display.BitmapData(325,110,false,0x00000000);
		...
		public function Small_Bkg_Torre()
		{
