package {
	...
	public class Small_Bkg_CBMarineReserve extends Sprite
	{
		...
		private var rect:Rectangle = new Rectangle(0, 0, 425, 110);
		private var pt:Point = new Point(0,0);
		private var bmp:BitmapData = new flash.display.BitmapData(425,190,true,0x00000000);
		private var waterbmd:BitmapData = new flash.display.BitmapData(425,110,false,0x00000000);
		...
		public function onEnterFrame(e:Event):void{
			...
			this.perlinOffset[0].y-=1;
			this.perlinOffset[0].x-=1;
		...
		public function Small_Bkg_CBMarineReserve()
		{
